  ...
  return (
    <>
      ...
      <div className="flex h-screen items-center justify-center">
        ...
        <h2 className=" text-2xl font-bold mb-5 text-primarycolor text-center">
            Bem-Vindo!
            {''}
        ...
        <div className="max-w-sm">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="flex  flex-col mt-3">
              <i className="fa fa-lock absolute text-primarycolor mt-5 ml-2 text-xl"></i>
